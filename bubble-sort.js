...
e promovendo a troca quando o secessor é maior que antecessor.

O percurso do vetor é feito tantas vezes quando necessário, até
nenhuma troca seja efetuada no percurso.
...
function bubbleSort (vetor){
    ...
    do {
        ...
        //Percurso do vetor até a PENULTIMA POSIÇÃO (length -2)
        for(let i = 0; i <= vetor.length - 2; i++) {
            comparacoes++
            //Comparando elemento da posição atual (i)
            //com elemento da frente (i + 1)
